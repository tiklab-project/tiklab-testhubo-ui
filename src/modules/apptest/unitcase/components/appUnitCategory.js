...
const AppUnitCategory = (props) =>{
    ...
    const onCategory = (item) =>{
        ...
        addRouter('/repository/apptest/unitcase');
    }
    ...
    const onNode = (item) => {
        ...
        addRouter('/repository/apptest/unitdetail');
    }
    ...
    const menu = (id)=>(
        <Menu>
            <Menu.Item >
                <AppUnitEdit name="添加用例"  unitcaseId={id}/>
            </Menu.Item>
            {/*<Menu.Item>*/}
            {/*    <Popconfirm*/}
            {/*        title="确定删除？"*/}
...
export default inject("categoryStore")(observer(AppUnitCategory));
