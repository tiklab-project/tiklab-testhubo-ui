...
const WebSceneCategory = (props) =>{
    ...
    const onCategory = (item) =>{
        ...
        addRouter('/repository/webtest/scenecase');
    }
    ...
    const onNode = (item) => {
        ...
        addRouter('/repository/webtest/scenedetail');
    }
    ...
    const menu = (id)=>(
        <Menu>
            <Menu.Item >
                <WebSceneEdit name="添加用例"  scenecaseId={id}/>
            </Menu.Item>
            {/*<Menu.Item>*/}
            {/*    <Popconfirm*/}
            {/*        title="确定删除？"*/}
...
export default inject("categoryStore")(observer(WebSceneCategory));
