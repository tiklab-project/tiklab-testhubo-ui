...
const ApiLeftTree = (props) =>{
    ...
    const addMenu = (
        <Menu>
            <Menu.Item key={1}>
                <ApiUnitEdit name={"添加Unit用例"} caseType={"unit"}/>
            </Menu.Item>
            <Menu.Item key={2}>
                <ApiSceneEdit name={"添加场景用例"} caseType={"scene"}/>
            </Menu.Item>
            <Menu.Item key={3}>
                <ApiPerfEdit name={"添加压测用例"} caseType={"perform"}/>
            </Menu.Item>
        </Menu>
    );
...
export default inject("categoryStore")(observer(ApiLeftTree));