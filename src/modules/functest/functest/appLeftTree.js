...
import FuncUnitEdit from "../unitcase/components/funcUnitEdit";
import FuncSceneEdit from "../scenecase/components/funcSceneEdit";

const FuncLeftTree = (props) =>{
    ...
    const addMenu = (
        <Menu>
            <Menu.Item key={1}>
                <FuncUnitEdit name={"添加Unit用例"} caseType={"unit"}/>
            </Menu.Item>
            <Menu.Item key={2}>
                <FuncSceneEdit name={"添加场景用例"} caseType={"scene"}/>
            </Menu.Item>
        </Menu>
    );
...
export default inject("categoryStore")(observer(FuncLeftTree));