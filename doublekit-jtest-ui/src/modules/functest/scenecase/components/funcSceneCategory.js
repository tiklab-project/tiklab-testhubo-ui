...
const FuncSceneCategory = (props) =>{
    ...
    const onCategory = (item) =>{
        ...
        addRouter('/repositorypage/functest/scenecase');
    }
    ...
    const onNode = (item) => {
        ...
        addRouter('/repositorypage/functest/scenedetail');
    }
    ...
    const menu = (id)=>(
        <Menu>
            <Menu.Item >
                <FuncSceneEdit name="添加用例"  scenecaseId={id}/>
            </Menu.Item>
            {/*<Menu.Item>*/}
            {/*    <Popconfirm*/}
            {/*        title="确定删除？"*/}
...
export default inject("categoryStore")(observer(FuncSceneCategory));
